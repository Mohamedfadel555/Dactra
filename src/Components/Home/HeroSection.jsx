    ...
    <div className="flex flex-col md:flex-row gap-10 justify-center relative items-center w-full px-5 md:px-[50px]">
      ...
      >
        <h1 className="text-[26px] leading-[32px] md:text-[34px] md:leading-[34px] lg:text-[50px] xl:text-[60px] max-w-[550px] lg:leading-16 font-bold">
          ...
          {isPatient
            ...
            : "in building a smarter medical practice."}
        </h1>
        ...
        <p className="font-semibold text-[13px] sm:text-[14px] xl:text-xl max-w-[350px] md:max-w-full">
          {isPatient ? (
            <>
              ...
              home. Connect with{" "}
              <span className="gradient-text">certified doctors</span>, manage
              prescriptions, and schedule appointments with ease. Ready to take
              control of your health?{" "}
              <span className="gradient-text">Get started</span> or book an
              appointment today.
            </>
          ) : (
            <>
              ...
              Easily organize appointments, engage with patients through posts,
              publish helpful articles, and build trust with verified ratings.
              Everything you need to manage and grow your practice,{" "}
              <span className="gradient-text">all in one place. </span>
              Stay in control of your schedule —{" "}
              <span className="gradient-text">check your appointments.</span>
            </>
          )}
        </p>
      ...
      >
        ...
        >
          ...
          />
          <div className="text-[#0069AB] z-30 md:text-[10px] lg:text-[14px] xl:text-[18px] flex absolute top-2/3 -left-1/4 shadow-[5px_6px_10px_#b7b7b7] w-fit gap-1.5 justify-center items-center px-[10px] py-[4px] bg-white rounded-[10px]">
